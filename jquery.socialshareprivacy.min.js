...
d+' /><label for="perma_status_twitter">'+a.services.twitter.display_name+"</label>"));a.services.gplus.status=="on"&&a.services.twitter.perma_option=="on"&&(d="",e.socialSharePrivacy_gplus=="perma_on"?d=' checked="checked"':d="",f.find("form fieldset").append('<input type="checkbox" name="perma_status_gplus" id="perma_status_gplus"'+d+' /><label for="perma_status_gplus">'+a.services.gplus.display_name+"</label>"));f.find("span.settings").css("cursor","pointer");b(f.find("span.settings"),c).live("mouseenter",
